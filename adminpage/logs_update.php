...
=======
              <img class="img" src="../userpage/Select.png" id="img" width="350px" height="250px">
>>>>>>> ff5c1e8b7d6305840fa87960b72592b1379932a9
...
<<<<<<< HEAD
    ...
    $query = "UPDATE `vechile_booking` SET `ph_no` = '$ph_no_',`vechile_id` = '$vechile_id',`model`='$model_', `location_` = '$location_' , `color`='$color_' , `varient`='$varient_',`status`='$status_' WHERE `booking_id` = '$booking'";
=======
...
>>>>>>> 1cdf2af65d82172eaf40cfced9c51468f03d980a
